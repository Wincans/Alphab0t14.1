...
typemenu = 'document'
img = setting.img
baper = 'SUB YT SEYBOT OFC'
apiku = 'https://seybotofc.github.io/'
...
await limitAdd(sender, limit)
		...
		if (!isQuotedSticker) return reply('```Reply stc nya```')
		            ...
		            dua = typeof anu[1] !== 'undefined' ? anu[1] : `SEYBOT OFC`
...
break
		...
		if (!isQuotedSticker) return reply('Reply stc nya!')
					...
					fakethumb(buffer,'```Nih kak, jgn lupa Support YT : SEYBOT OFC```')
					fs.unlinkSync(ran)
					})
					await limitAdd(sender, limit)
					break   
        ...
        break;
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					anuu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${numbernye}@s.whatsapp.net`, 'remoteJid': '6289523258649-1604595598@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 Bot by Seybot 」`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
